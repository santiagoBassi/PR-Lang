...
int get_positive_integer_from_stdin(){
    ...
    input_counter == 1 ? "st" : input_counter == 2 ? "nd" : input_counter == 3 ? "rd" : "th");
    input_counter++;int out = 0;
...
int function1(int x,int y){
    ...
    return function0(function1( x , y ));
}
