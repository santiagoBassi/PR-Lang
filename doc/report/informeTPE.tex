...
El backend toma el AST generado por el frontend del compilador y genera código en el lenguaje C. El código de salida se produce en una sola pasada por el AST, el recorrido recursivo del árbol se asiste de una tabla de funciones que contiene información pertinente a cada función, tales como argumentos, cantidad de argumentos y nombre de la función.

La tabla de funciones utiliza un hashmap que utiliza como clave el nombre de la función y como valor una estructura que tiene información relevante a la función. Se utilizó la implementación de hashmap de X. Como nuestro lenguaje permite que los nombres de las funciones sean no alfanúmericas, la tabla de funciones tiene que tener un mapeo entre el nombre de la función en nuestro lenguaje y en el código C.
